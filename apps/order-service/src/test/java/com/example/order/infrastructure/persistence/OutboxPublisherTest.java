...
class OutboxPublisherTest {
    ...
    void publishPendingEvents_pendingExists_sendsAndMarksPublished() {
        ...
        org.assertj.core.api.Assertions.assertThat(entry.getStatus()).isEqualTo("PUBLISHED");
        org.assertj.core.api.Assertions.assertThat(entry.getPublishedAt()).isNotNull();
    }
    ...
    void publishPendingEvents_senderFails_stopsAndKeepsPending() {
        ...
        org.assertj.core.api.Assertions.assertThat(entry1.getStatus()).isEqualTo("PENDING");
        org.assertj.core.api.Assertions.assertThat(entry2.getStatus()).isEqualTo("PENDING");
    }
