...
class OAuthControllerTest {
    ...
    void initiateGoogleLogin_validCallbackUrl_redirectsToGoogle() throws Exception {
        ...
        given(googleOAuthService.buildAuthorizationUrl(callbackUrl))
    ...
    void initiateGoogleLogin_invalidCallbackUrl_returns400() throws Exception {
        given(googleOAuthService.buildAuthorizationUrl("http://evil.com/callback"))
    ...
    void handleGoogleCallback_success_redirectsWithTokens() throws Exception {
        ...
        CallbackResult callbackResult = CallbackResult.success("http://localhost:3000/oauth/callback", loginResult);
        given(googleOAuthService.handleCallback(any())).willReturn(callbackResult);
    ...
    void handleGoogleCallback_failure_redirectsWithError() throws Exception {
        CallbackResult callbackResult = CallbackResult.failure("http://localhost:3000/oauth/callback");
        given(googleOAuthService.handleCallback(any())).willReturn(callbackResult);
    ...
    void handleGoogleCallback_errorWithValidState_redirectsWithError() throws Exception {
        given(googleOAuthService.resolveCallbackUrl("valid-state"))
    ...
    void handleGoogleCallback_errorWithExpiredState_returns400() throws Exception {
        given(googleOAuthService.resolveCallbackUrl("expired-state"))
