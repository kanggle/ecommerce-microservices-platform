...
- [ ] 프로모션 생성/조회/수정/삭제 API 동작
- [ ] 쿠폰 발급 및 조회 API 동작
- [ ] 주문 시 쿠폰 적용으로 할인 금액 반영
- [ ] 사용된 쿠폰 재사용 불가
- [ ] 만료 쿠폰 자동 처리
- [ ] 쿠폰 사용 이벤트 발행
...
- 서비스 아키텍처 결정 필요 (DDD 또는 Layered)

---

# Implementation Notes

- ready로 이동 전 promotion-service 스펙 및 API 계약 작성 필요
- order-service와의 연동 방식 설계 필요
