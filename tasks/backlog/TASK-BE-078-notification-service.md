...
- 서비스 아키텍처 결정 필요 (Hexagonal 권장 — 외부 채널 어댑터 교체 용이)

---

# Implementation Notes

- ready로 이동 전 notification-service 스펙 및 API 계약 작성 필요
- 외부 메일 서비스 추상화 (어댑터 패턴)
