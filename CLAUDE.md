...
4. Follow `specs/platform/entrypoint.md` for spec reading order
5. Determine the target service's `Service Type` from `specs/services/<service>/architecture.md` and read the matching `specs/platform/service-types/<type>.md` (exactly one file)
