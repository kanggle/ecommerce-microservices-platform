...
Prerequisite: read `specs/platform/coding-rules.md` before using this skill. See also `backend/transaction-handling.md` for code-level `@Transactional` patterns.
