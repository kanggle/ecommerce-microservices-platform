...
Prerequisite: read `specs/platform/coding-rules.md` (TypeScript Rules) before using this skill. See `frontend/architecture/feature-sliced-design.md` or `frontend/architecture/layered-by-feature.md` for placement rules.
