...
Prerequisite: read `specs/contracts/http/auth-api.md` and `backend/jwt-auth.md` before using this skill. For backend-side patterns see `backend/jwt-auth.md` and `backend/redis-session.md`.
