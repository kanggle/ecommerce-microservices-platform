...
Every contract version must have a contract test (see `testing/contract-test.md`) that:
...
- Reject events with unsupported version into DLQ (see `messaging/consumer-retry-dlq.md`)
