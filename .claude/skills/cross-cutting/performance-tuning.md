...
Prerequisite: read `specs/platform/testing-strategy.md` and `specs/platform/observability.md` before using this skill. Use `cross-cutting/observability-setup.md` for instrumentation and `cross-cutting/caching.md` for cache strategy.
...
1. **Reproduce** under realistic load (`testing/e2e-test.md`)
...
See `frontend/bundling-perf.md` for bundle and asset optimization.
...
- Always paginate (`backend/pagination.md`)
...
- Use refresh-ahead pattern (`cross-cutting/caching.md`)
