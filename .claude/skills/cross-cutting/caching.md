...
Prerequisite: read `specs/platform/architecture.md` and `specs/platform/observability.md` before using this skill. This skill is the policy/checklist layer; concrete Redis usage patterns live in `backend/redis-session.md` and `backend/rate-limiting.md`.
