...
Prerequisite: read `specs/platform/observability.md` before using this skill. Concrete Micrometer/OTel patterns live in `backend/observability-metrics.md`. Stack deployment lives in `infra/monitoring-stack.md`.
