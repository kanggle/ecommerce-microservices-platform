...
Prerequisite: read `specs/platform/service-types/frontend-app.md` before using this skill.

---

## Orchestration Order

1. **Architecture pattern** — choose `frontend/architecture/feature-sliced-design.md` or `frontend/architecture/layered-by-feature.md` and declare in `architecture.md`
...
5. **Auth** — `frontend/auth-client.md` (HttpOnly cookies + server refresh route)
6. **Component primitives** — `frontend/component-library.md` (shadcn/ui style under `shared/ui/`)
7. **State management** — `frontend/state-management.md` (React Query for server state)
8. **Forms** — `frontend/form-handling.md` or `frontend/server-actions.md`
9. **Loading / error UX** — `frontend/loading-error-handling.md`
10. **Bundling** — `frontend/bundling-perf.md`
...
Verify against `specs/platform/service-types/frontend-app.md` Acceptance section. Specifically:
