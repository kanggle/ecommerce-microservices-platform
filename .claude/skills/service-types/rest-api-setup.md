...
3. **API skeleton** — `backend/springboot-api.md`
4. **Validation** — `backend/validation.md`
5. **DTO mapping** — `backend/dto-mapping.md`
6. **Persistence** — `database/schema-change-workflow.md`, `database/transaction-boundary.md`
7. **Transactions** — `backend/transaction-handling.md`
8. **Auth** — `backend/jwt-auth.md`, `backend/gateway-security.md`
9. **Pagination** — `backend/pagination.md` (every list endpoint)
10. **Idempotency** — see "Idempotency" below
11. **Versioning** — `cross-cutting/api-versioning.md`
12. **Error handling** — `backend/exception-handling.md`
13. **Observability** — `cross-cutting/observability-setup.md`, `backend/observability-metrics.md`
14. **Tests** — `backend/testing-backend.md`, `testing/contract-test.md`, `testing/e2e-test.md`
