...
Prerequisite: read `specs/platform/observability.md` and `cross-cutting/observability-setup.md` before using this skill. Service-side instrumentation lives in `backend/observability-metrics.md`.
