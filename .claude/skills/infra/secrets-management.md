...
Prerequisite: read `specs/platform/security-rules.md` and `cross-cutting/security-hardening.md` before using this skill. CI/CD-side secret usage lives in `infra/ci-cd.md`.
