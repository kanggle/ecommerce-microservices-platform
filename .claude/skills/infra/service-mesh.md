...
Prerequisite: read `specs/platform/architecture.md`, `specs/platform/security-rules.md`, and `cross-cutting/security-hardening.md` before using this skill. Service-mesh adoption is **optional** — use this skill only when zero-trust mTLS or advanced traffic shaping is required.
...
This is the **mesh-level** allowlist. Application-level RBAC (`backend/gateway-security.md`) still applies.
