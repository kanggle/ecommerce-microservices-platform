...
```
/refactor <service>                                        # scan entire service + refactor
/refactor <service> <target> <refactoring-type>            # refactor specific target
/refactor <service> --dry-run                              # analyze only (show plan)
/refactor <service> --focus=<category>                     # filter by category
```
...
/refactor order-service OrderAggregate method extraction
/refactor order-service presentation layer cleanup
/refactor order-service --dry-run
/refactor order-service --focus=duplication
```
