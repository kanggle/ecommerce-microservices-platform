...
이커머스 도메인의 에러 코드는 [../../platform/error-handling.md](../../platform/error-handling.md)에 정의되어 있다. 이 파일은 **복사하지 않고 참조만** 한다.
...
신규 에러 코드가 필요하면 [../../platform/error-handling.md](../../platform/error-handling.md)를 먼저 갱신한 뒤 이 문서에는 참조만 추가한다.
