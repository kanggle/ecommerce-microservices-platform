...
- Naming: `specs/platform/naming-conventions.md`
- Coding rules: `specs/platform/coding-rules.md`
- Shared library policy: `specs/platform/shared-library-policy.md`
- Testing strategy: `specs/platform/testing-strategy.md`
